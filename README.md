...
/ / USER CODE END Header / / Includes ------------------------------------------------------------------*/ #include "main.h" #include "stdio.h" #if defined(GNUC)

#define PUTCHAR_PROTOTYPE int __io_putchar(int ch) #endif /* Private includes ----------------------------------------------------------/ / USER CODE BEGIN Includes */
...
/* Infinite loop / / USER CODE BEGIN WHILE / while (1) { printf(" Ryan David Prasad\n"); printf("212224040282\n"); HAL_Delay(500); / USER CODE END WHILE */

/* USER CODE BEGIN 3 */
} /* USER CODE END 3 */ } PUTCHAR_PROTOTYPE { HAL_UART_Transmit(&huart2, (uint8_t *)&ch, 1, 0xFFFF);
...
<img width="1280" height="671" alt="image" src="https://github.com/user-attachments/assets/9db338d2-9fa3-440e-865a-b532af80cc0a" />
